...
export class Helicopter extends GrObject {
  ...
  constructor(params = {}) {
    ...
    //
    this.altitude = params.altitude || 20;
  ...
  stepWorld(delta, timeOfDay) {
    ...
    if (this.pads.length) {
      switch (this.state) {
        ...
        case 2: // descend
          this.helicopter.position.y -= deltaSlowed;
          if (this.helicopter.position.y <= this.current.mesh.position.y + 0.01) {
            this.helicopter.position.y = this.current.mesh.position.y + 0.01;
            this.state = 3;
